...
//Выбрать регион и зону
  ...
  //Список имен или идентификаторов зон доступности в регионе, если делать NAT в каждой зоне, то private_subnets = количество azs
  azs             = ["eu-west-3a","eu-west-3b","eu-west-3c"]
  //Не задаю, так как буду создавать без использования vpc дальше.
